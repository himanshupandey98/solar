...
<div id="user" class="lg:grid grid-cols-5 mt-2 ">
        ...
        <div class="col-start-2 col-span-4 ">
            <p class="font-bold text-xl"><a href="/member/{{($member->id)}}">{{ucwords($member->name)}}</a></p>
        ...
        <div class="col-start-8 col-span-2 m-1 py-1">
        <p class="text-xs border border-blue-400 px-2 text-center rounded-xl  bg-yellow-400 font-semibold hover:bg-gray-100"><a href="member?category={{$member->category->id}}">{{$member->category->category}}</a>
            </p>
