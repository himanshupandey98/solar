		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section"> Create Post</h2>
				</div>
			</div>
			<div class="row justify-content-center  ">
            ...
            <div x-data="{ show:true }"
                ...
                @endif
		      	...
		      	<form action="/post" class="signin-form" method="post">
                  @csrf
                ...
                <input type="hidden" name="user_id" value="{{auth()->user()->id}}">
                      ...
                      <div class="form-group pt-3">
		      			<input type="text" name="sitename" class="form-control border" placeholder="Enter sitename" required value="{{old('sitename')}}">
		      		</div>
                      ...
                      <div class="form-group pt-3">
		      			<input type="text" name="location" class="form-control border" placeholder="Enter location" required value="{{old('location')}}">
		      		</div>
